...
if(!fs.readFileSync(path.join(root,'service-worker.js'),'utf8').includes('renoweet-focus-hub-v4.4.4-21'))throw new Error('Service-worker cache version was not bumped for v4.4.4.');
